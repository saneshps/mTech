            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                    <div class="clients-box-pic">
                        <img src="./img/clients/shoba.png" alt="logo">
                    </div>
                    <div class="client-box-cnt">
                        <h5> Shoba Developers </h5>
                        <h5> Commercial </h5>
                        <h5> Dubai </h5>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                    <div class="clients-box-pic">
                        <img src="./img/clients/down-town.png" alt="logo">
                    </div>
                    <div class="client-box-cnt">
                        <h5> Down Town Hospital </h5>
                        <h5> Health & Aged care </h5>
                        <h5> Abu Dhabi </h5>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                    <div class="clients-box-pic">
                        <img src="./img/clients/ambassador.png" alt="logo">
                    </div>
                    <div class="client-box-cnt">
                        <h5> Ambassador Hotels </h5>
                        <h5> Tourism </h5>
                        <h5> Sharjah </h5>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                    <div class="clients-box-pic">
                        <img src="./img/clients/royal.png" alt="logo">
                    </div>
                    <div class="client-box-cnt">
                        <h5> Ambassador Hotels </h5>
                        <h5> Tourism </h5>
