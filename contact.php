            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="contact-box">
                        ...
                        <h5> Address</h5>
                        <h6> DUBAI The Onyx Tower 2, Room 1113, <br>
                            Level 11, The Greens, <br>
                            Al Barsha Heights PO Box 213081
                        </h6>
                    </div>
                </div>
                <!-- 1 -->
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="contact-box">
                        ...
                        <h5> Email & Phone </h5>
                        <h6> info@m-tech.global <br>
                            Telephone : +971 4 315 8500 <br>
                            Phone : +971 4 315 8600
                        </h6>
                    </div>
                </div>
                <!-- 1 -->
